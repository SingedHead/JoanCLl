function [unitVectors, forceValues, cg] = calculateUnitVectors(fIDj, fixedPoints, eul)
    ...
    % Inputs:
    % fIDj - Vector 1x15 amb forces, moments i coordenadas de Q1, Q2 y Q3
    % fixedPoints - Matriz 6x3  coordenadas dels punts bases [O1; O2; O3; O4; O5; O6]
    % Outputs:
    % unitVectors - Matriz 6x3 con los vectores unitarios resultantes

    % Validar dimensiones de las entradas
